...
namespace Young_Artists.Models
{
    public partial class YoungArtistsContext : DbContext
    {
        ...
        public virtual DbSet<SeatState> SeatStates { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Young-Artists;Integrated Security=True", x => x.UseNetTopologySuite());
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.OrderCreatTimestamp)
                    .HasMaxLength(20)
                    .HasColumnName("order_creat_timestamp");
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                ...
                entity.Property(e => e.EvnetId).HasColumnName("evnet_id");
            ...
            modelBuilder.Entity<SeatState>(entity =>
            {
                entity.ToTable("seat_state");
